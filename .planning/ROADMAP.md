...
**Plans**: 10 plans (4 original + 2 gap-closure r1 + 4 gap-closure r2)
**Wave 1**
...
**Wave 7 (gap-closure r2 gate; blocked on Wave 6)**
  ...
  - [ ] 10-10-PLAN.md — Full suite GREEN against the packaged app + fresh packaged ui-lab capture (now enforcing name-completeness, no leaked amber) + BLOCKING human re-verify of live amber / gutter / names; flips the Nyquist gate ONLY on an explicit unqualified "approved" (Wave 7)
