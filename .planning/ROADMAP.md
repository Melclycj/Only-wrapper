...
- [ ] **Phase 10: Sidebar Visual Polish** — Apply the tokens to the session sidebar: clear hierarchy, legible 5-state status, unmistakable active session (expanded + collapsed). (gaps found 2026-06-11 — human gate)
...
| 10. Sidebar Visual Polish | v1.1 | 5/6 | In Progress|  |
